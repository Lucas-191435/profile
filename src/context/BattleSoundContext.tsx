...
interface BattleSoundContextType {
    currentSound: string;
...
const BattleSoundContext = createContext<BattleSoundContextType | undefined>(undefined);

export const BattleSoundProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    return (
        <BattleSoundContext.Provider value={{
            currentSound,
            setCurrentSound,
            isPlayingSound,
            isBgmPlaying,
            ...
            {children}
        </BattleSoundContext.Provider>
    );
};

export const useBattleSoundContext = () => {
    const context = useContext(BattleSoundContext);
    if (!context) {
        throw new Error("useBattleSoundContext must be used within a BattleSoundProvider");
    }
    return context;
};